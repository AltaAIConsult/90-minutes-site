// main.js (FINAL VERSION with all fixes and UI changes)
...
const client = createClient({
  projectId: 'llmrml4v', dataset: 'production', useCdn: true, apiVersion: '2024-03-11',
})
...
async function getHero() {
  ...
  if (heroData.backgroundType === 'video' && heroData.backgroundVideo?.asset?._ref) {
    ...
    if(videoAsset.url) {
      ...
      // FIX: Changed 'background' to 'backgroundElement'
